...
/*:
 * @plugindesc (v.1.2.1)[BASIC] Simple quests system
...
Window_SQSQuestsList = class Window_SQSQuestsList extends Window_Selectable {
  ...
  drawItem(index) {
    ...
    if (SQSM.isQuestHaveNewMark(quest.id)) {
...
//Plugin PKD_SimpleQuestSystem automatic build by PKD PluginBuilder 1.9.2 11.11.2021
